...
<x-guest-layout>
        ...
        <section id="about" class="py-4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        {{-- @if (!empty($mvp_realtors))
                            @foreach ($mvp_realtors as $realtor)
                                <div class="card">
        ...
        <section id="team" class="py-5">
            <div class="container">
                ...
                <div class="row text-center">
                    {{-- @if (!empty($realtors))
                        @foreach ($realtore as $realtor)
                            <div class="col-md-4">
                                <img src="{{ realtor.photo.url }}" alt="" class="rounded-circle mb-3">
                                <h4>{{ realtor.name }}</h4>
                                <p class="text-success">
                                    <i class="fas {% if realtor.is_mvp %}fa-award{% endif %} text-success mb-3"></i> Realtor</p>
                                <hr>
                                <p>
